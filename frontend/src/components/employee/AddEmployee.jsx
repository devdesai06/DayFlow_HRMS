...
import {
  UserPlus, Mail, Briefcase, Building2, Copy, CheckCircle2,
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        width: "100%", maxWidth: "460px", boxShadow: "0 24px 60px rgba(0,0,0,0.18)",
        ...
        <div style={{
          ...
          <p style={{ fontSize: "13px", color: "#92400e", margin: 0, lineHeight: 1.5 }}>
            These credentials are shown <strong>only once</strong>. Copy and share
            them securely with the employee before closing.
          </p>
        </div>
        ...
        <div style={{ marginBottom: "16px" }}>
          ...
          <div style={{
            ...
            <span style={{ flex: 1, fontSize: "14px", color: "#0f172a", fontFamily: "monospace" }}>
              {credentials.email}
            </span>
            <button onClick={() => copy(credentials.email, setCopiedEmail)} style={{
              background: copiedEmail ? "#d1fae5" : "#eef2ff",
              border: "none", borderRadius: "6px", padding: "5px 9px",
              cursor: "pointer", display: "flex", alignItems: "center", gap: "4px",
              fontSize: "12px", color: copiedEmail ? "#065f46" : "#4f46e5", fontWeight: 600,
              transition: "all 0.2s",
            }}>
        ...
        <div style={{ marginBottom: "28px" }}>
          ...
          <div style={{
            ...
            <span style={{
              flex: 1, fontSize: "15px", color: "#0f172a",
              fontFamily: "monospace", letterSpacing: "2px",
              filter: showPass ? "none" : "blur(5px)", transition: "filter 0.2s",
            }}>
            ...
            <button onClick={() => copy(credentials.generatedPassword, setCopiedPassword)} style={{
              background: copiedPassword ? "#d1fae5" : "#f0fdf4",
              border: "none", borderRadius: "6px", padding: "5px 9px",
              cursor: "pointer", display: "flex", alignItems: "center", gap: "4px",
              fontSize: "12px", color: copiedPassword ? "#065f46" : "#16a34a", fontWeight: 600,
              transition: "all 0.2s",
            }}>
...
const AddEmployee = ({ onSuccess }) => {
  const [form, setForm] = useState({ name: "", email: "", jobTitle: "", department: "" });
        ...
        <form onSubmit={handleSubmit} style={{ padding: "24px 28px" }}>
          {error && (
            <div style={{
              ...
              borderRadius: "9px", padding: "11px 14px", marginBottom: "18px",
              fontSize: "13.5px", color: "#dc2626", display: "flex", gap: "8px", alignItems: "center",
            }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "16px" }}>
            ...
            <div style={{ gridColumn: "1 / -1" }}>
              <label style={labelStyle}><span style={{ color: "#e11d48" }}>*</span> Full Name</label>
            ...
            {/* Email */}
            <div style={{ gridColumn: "1 / -1" }}>
              <label style={labelStyle}><span style={{ color: "#e11d48" }}>*</span> Work Email</label>
              <input
                type="email" name="email" value={form.email} onChange={handleChange} required
                placeholder="e.g. priya@company.com" style={inputStyle}
                onFocus={e => e.target.style.border = "1.5px solid #4f46e5"}
                onBlur={e => e.target.style.border = "1.5px solid #e2e8f0"}
              />
            </div>
            ...
            {/* Job Title */}
            <div>
              <label style={labelStyle}><Briefcase size={11} style={{ marginRight: 5 }} />Job Title</label>
              <input
            ...
            {/* Department */}
            <div>
              <label style={labelStyle}><Building2 size={11} style={{ marginRight: 5 }} />Department</label>
              <input
          ...
          {/* Info notices */}
          <div style={{
            marginTop: "20px", background: "#f0fdf4", border: "1.5px solid #bbf7d0",
            borderRadius: "9px", padding: "12px 14px", fontSize: "12.5px", color: "#166534",
            display: "flex", alignItems: "flex-start", gap: "8px",
          }}>
            <ShieldCheck size={14} style={{ flexShrink: 0, marginTop: 1 }} />
            <span>
              A <strong>secure password</strong> will be auto-generated using cryptographic
              randomness and hashed with bcrypt. The plain-text is shown once after submission.
            </span>
          </div>
          ...
          <button type="submit" disabled={loading} style={{
            ...
            color: "white", fontWeight: 600, fontSize: "14.5px",
